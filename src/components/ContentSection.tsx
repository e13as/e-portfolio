        ...
        <FadeIn>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-8">
            ...
            <motion.div 
              ...
              whileHover={{ scale: 1.13, rotateY: 5 }}
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className="mt-6 md:mt-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center md:gap-4">
                  ...
                  <div className="mt-4 md:mt-0 md:ml-6 flex justify-center md:justify-start">
                    <a
                      href="/lebenslauf.pdf"
                      download
                      className="group inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-gradient-to-r from-green-500 via-emerald-400 to-blue-400 text-white text-sm font-semibold shadow-lg border-2 border-green-400 focus:outline-none focus:ring-2 focus:ring-green-400 transition-all duration-300 relative overflow-hidden
                        hover:from-green-400 hover:via-blue-400 hover:to-purple-500 hover:border-blue-400 hover:scale-105"
                    >
                      {/* Magic Glow Effekt */}
                      <span className="absolute inset-0 rounded-full pointer-events-none opacity-0 group-hover:opacity-80 transition duration-300 blur-[6px] bg-gradient-to-r from-green-400 via-blue-400 to-purple-500 animate-pulse" />
                      <svg className="w-4 h-4 relative z-10" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v12m0 0l-4-4m4 4l4-4M4 20h16" />
                      </svg>
                      <span className="relative z-10">Lebenslauf als PDF</span>
                    </a>
                  </div>
                </div>
              </div>
